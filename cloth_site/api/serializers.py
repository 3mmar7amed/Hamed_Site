...
from products.models import dialyIncome, products ,Expenses,dialyProfit, sold_products  , monthly_profit , Returns_products , bills , customer_note , Expenses_details ,products_inTheInVentory
